...
contains
    ...
    subroutine compute_numerical_jacobian
        ...
        use module_ccfv_data_soln       , only : w, u, u2w, dtau, Temp, mu, gradw, gradT, gamma
        ...
        use module_input_parameter      , only : navier_stokes, use_limiter
        ...
        real(p2), dimension(5)      :: u1, u2, u_perturb, w1,w2, w_perturb
